...
order by events_tbl.shortdesc</cfquery>
			...
			<cfif getevent.recordcount GT 0><p>		<cfoutput><strong><a href="#application.url#/public/calendar.cfm?view=d&month=#url.Month#&year=#url.Year#&day=#url.day#">#dateformat(currentdate,"m/d")#</a></cfoutput>:</strong><br />
<ul>
					<cfoutput query="getevent">
		<li><cfif events_link_override eq 1><a href="#events_link#"><cfelse><a href="#application.url#/public/calendar_detail.cfm?eventid=#eventid#&siteid=#variables.upcomingevents_id#&month=#url.month#&year=#url.year#&day=#url.day#"></cfif><cfif shortdesc EQ 'Key Academic Date'><strong>#shortdesc#</strong><cfelse>#shortdesc#</cfif></a><br />
