...
<cfcatch type="Any">
   <cfmail to="jdrevs@luc.edu" from="jdrevs@luc.edu" subject="Skin Error Occurred">#url.skin#
   Good luck finding it.#cfcatch.message# 
<strong>Page User Coming From:</strong>#cgi.HTTP_REFERER#<br>
        <strong>HTTP User Agent:</strong>#cgi.HTTP_USER_AGENT#<br>
        <strong>Remote Address:</strong>#cgi.REMOTE_ADDR#<br></cfmail>There is no site with this template. Please <a href="http://www.luc.edu/calendar">click here</a> to return to the calendar.<cfabort>
</cfcatch>
</cftry>
...
where siteid=#url.siteid#
  ...
  <ul id="submitevent">
    ...
    <cfif url.siteid is '278'>
      <cfoutput>
        <li><b>SUBMIT AN EVENT:</b> &nbsp; <a href="http://www.luc.edu/quinlan/calendarsubmission/">Students</a> &nbsp; <a href="https://quinlanevents.wufoo.com/forms/quinlan-school-of-business-event-approval-form/">Faculty</a></li>
      </cfoutput>
      <cfelse>
      <cfoutput>
        <li><a href="calendar_submit.cfm">Submit an Event</a> </li>
