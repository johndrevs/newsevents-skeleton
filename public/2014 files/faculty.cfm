...
<!-- header column 2 -->
		<tr>
			...
			<td id="column2" width="100%" valign="top" align="right"><div style="text-align:left;"><img src="images/hdr_news.gif" width="400" height="60" alt="University News" /></div></td>
...
<p><strong>NOTE:</strong> To edit experts' info please contact media relations at <a href="mailto:news@luc.edu">news@luc.edu</a>.</p>
</div></div>
