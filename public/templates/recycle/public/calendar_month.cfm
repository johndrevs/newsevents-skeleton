...
<cfoutput>
		...
		<cfif (month IS "#DatePart('m', Now())#") AND (year IS "#DatePart('yyyy', Now())#")>&nbsp;&nbsp;#MonthAsString(month)#&nbsp;#year#&nbsp;&nbsp;<a href="#variables.location#?month=#NextMonth#&year=#NextYear#&day=#url.day#&range=#url.range#&siteid=#url.siteid#&audience=#url.audience#&view=#url.view#">next month</a>
		<cfelse>
<a href="#variables.location#?month=#LastMonth#&year=#LastYear#&day=#url.day#&range=#url.range#&siteid=#url.siteid#&audience=#url.audience#&view=#url.view#">previous month</a>&nbsp;&nbsp;#MonthAsString(month)#&nbsp;#year#&nbsp;&nbsp;<a href="#variables.location#?month=#NextMonth#&year=#NextYear#&day=#url.day#&range=#url.range#&siteid=#url.siteid#&audience=#url.audience#&view=#url.view#">next month</a>
		</cfif>
