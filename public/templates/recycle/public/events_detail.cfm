...
<img src="/newsevents/secure/images/nande.gif" width="261" height="57" alt="Loyola University Chicago News and Events">
<cfquery name="getevents" datasource="#application.datasource_select#">
  ...
  EVE.LONGDESC, EVE.INFO_CLOB, EVE.EVENTS_LINK,  EVE.EVENTS_LINK_OVERRIDE,
