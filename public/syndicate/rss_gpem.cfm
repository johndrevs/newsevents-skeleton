...
<cfscript>
   ...
   <item>
         <title>#title#</title> 
         <description><cfif (isDefined("qgetevents.allday") AND qgetevents.allday EQ 1) or timeformat(qgetevents.startdate[ctr],"h:mm:tt") EQ '1:00:am'>
	...
	<cfelse>
         ...
         <eventDate>#dateformat(qgetevents.startdate[ctr],"mm/dd/yyyy")#</eventDate>
         <eventTime>#timeformat(qgetevents.startdate[ctr],"h:mm TT")#</eventTime>
         <eventID>#qgetevents.eventid[ctr]#</eventID>
         <location>#getlocation.location_name#  #qgetevents.specificlocation[ctr]#</location>
   </item>
   </cfoutput>
</cfloop>
<cfoutput>
