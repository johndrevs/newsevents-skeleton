...
<cfif isDefined("url.year") IS 0>
	<cfset url.day = "#DatePart('yyyy', Now())#">
</cfif>
<cfif isDefined("url.month") IS 0>
	<cfset url.day = "#DatePart('m', Now())#">
</cfif>
<cfset currentdate = CreateDate(url.year, url.month, url.day)>
...
<cfscript>
   ...
   <item>
         <title>#title#</title> 
         <description><cfif (isDefined("qgetevents.allday") AND qgetevents.allday EQ 1) or timeformat(qgetevents.startdate[ctr],"h:mm:tt") EQ '1:00:am'><cfelseif qgetevents.enddate[ctr] IS ''>#timeformat(qgetevents.startdate[ctr],"h:mm TT")#<cfelseif datecompare(qgetevents.startdate[ctr],qgetevents.enddate[ctr],"d") NEQ 0>#timeformat(qgetevents.startdate[ctr],"h:mm TT")#
		 to
		  #timeformat(qgetevents.enddate[ctr],"h:mm TT")#<cfelseif datecompare(qgetevents.startdate[ctr],qgetevents.enddate[ctr],"m") EQ 0  and parameterexists(form.enddateno) neq 1>#timeformat(qgetevents.startdate[ctr],"h:mm TT")# - #timeformat(qgetevents.enddate[ctr],"h:mm tt")#<cfelse></cfif></description>
