...
<a href="javascript:cal3.popup();"><img src="../scripts/cal.gif" width="16" height="16" border="0" alt="Click Here to Pick up the timestamp"></a><br/>
				<input type="Text" name="startdate"><br/><br/>
Event End Date and Time:<a href="javascript:cal4.popup();"><img src="../scripts/cal.gif" width="16" height="16" border="0" alt="Click Here to Pick up the timestamp"></a><br/>
...
Link <!--(will create event as a link to page)--><br/>
