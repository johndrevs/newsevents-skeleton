	...
	<table width="95%" border="0" cellspacing="1" cellpadding="4" class="tabulargrey">
		...
		<cfoutput>
			<tr>
				...
				<cfif getusers.recordcount gt variables.nextpub><a href="#variables.location#?startindex=#variables.next#">next #variables.paginatelevel# records</a>
				</cfif>
				<cfif getusers.recordcount gt variables.nextpub><a href="#variables.location#?startindex=#variables.end#">last records</a>
				</cfif>
