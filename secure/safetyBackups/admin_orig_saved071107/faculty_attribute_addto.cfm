...
<table border="0" cellspacing="1" cellpadding="4" class="tabulargrey">
	...
	<cfoutput query="getavailable"><tr><td>#category_name#<!--- #category_id# ---></td><td><a href="faculty_attribute_addtoaction.cfm?faculty_id=#url.faculty_id#&category_id=#category_id#&LID=#url.LID#">add to expert</a> | <a href="faculty_category_delete.cfm?category_id=#category_id#">delete subcategory</a></td></th></cfoutput>
