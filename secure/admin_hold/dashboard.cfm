...
order by priority
				...
				<tr>
					<td><a href="##" class="date" onClick="window.open('/newsevents/admin/sites_view.cfm?siteid=#siteid#','mywindow','width=640,height=480,scrollbars=yes,resizable=yes')">#site_name#</a></td>
...
<strong>#session.firstname# #session.lastname#</strong>							
			...
			<cfelseif location contains 'board' or location contains 'view' or location contains 'ews_action' or (parameterexists(url.showdef) and url.showdef is 'yes')><h3>Definitions</h3>
