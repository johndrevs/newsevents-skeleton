			...
			<cfoutput query="getsites">
				<form action="admin_action.cfm" method="post">
					<tr>
						...
						<input type="submit" name="siteedit" value="edit" class="button">
                        <input type="button" onclick="window.open('/newsevents/public/calendar.cfm?view=mw&siteid=#siteid#','mywindow')" value="view" class="button"></td>
					</tr>
