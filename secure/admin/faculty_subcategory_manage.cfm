...
<h2>Manage Sub Categories</h2>
	...
	<table border="0" cellspacing="1" cellpadding="4" class="tabulargrey">
		...
		<cfoutput query="getsubcategory">
			<tr>
				<td>#category_name#</td>
				<td><a href="faculty_subcategory_delete.cfm?categories_ref_id=#categories_ref_id#">remove subcategory from main category</a> | <a href="faculty_category_edit.cfm?category_id=#category_id#">edit category</a> | <a href="faculty_category_delete.cfm?category_id=#category_id#">delete subcategory</a></td></th>
		</cfoutput>
		<cfoutput>
			<tr>
