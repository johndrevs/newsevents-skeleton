...
<form action="il_weekly_generate_action.cfm" method="post" name="events_add" id="events_add">
<table cellpadding="0" cellspacing="0" border="0" class="tabulargrey">
		...
		<tr>
			<td>Publication</td>
			<td>Inside Loyola Weekly <input type="radio" name="publication" value="insideloyolaweekly"> Loyola FOCUS <input type="radio" name="publication" value="focus"></td>
		</tr>
	</table>
