...
SELECT CUNVMCS.USERS.email, CUNVMCS.USERS.passcode,CUNVMCS.USERS.USER_NAME,CUNVMCS.USERS.ISACTIVE,CUNVMCS.USERS.userid
FROM CUNVMCS.USERS
...
<h2>Add user</h2>
<p>The username you requested has already been assigned. Please <a href="users_add.cfm">click here</a> and choose a different username.xxxxxxxx<cfoutput>|#get_user.user_name#|#get_user.isactive#|</cfoutput></p>
