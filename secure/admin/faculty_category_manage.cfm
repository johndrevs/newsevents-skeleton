...
<h2>Faculty Main Categories</h2>
	...
	<table border="0" cellspacing="1" cellpadding="4" class="tabulargrey">
		...
		<cfoutput query="getcategory">
			<tr>
				<td>#category_name#</td>
				<td><a href="faculty_category_edit.cfm?category_id=#category_id#">edit category</a> | <a href="faculty_category_delete.cfm?category_id=#category_id#">delete category</a> | <a href="faculty_subcategory_manage.cfm?category_id=#category_id#">manage subcategories</a></td>
			</tr>
		</cfoutput>
		<tr>
