...
<cfoutput>
<nav id="view">
<h3 id="name">Week of #dateformat(daterangebeg, "mmmm d, yyyy")# </h3>
<ul id="navi">
...
<cfquery name="getevent" datasource="#application.datasource_select#" maxrows=25>
...
<li><cfif timeformat(startdate,"h:mm:tt") EQ '1:00:am'><cfelse>#timeformat(startdate,"h:MM TT")#<cfif enddate EQ ''> <cfelse><cfif datecompare(startdate,enddate,"m") EQ 0> - #timeformat(enddate,"h:mm tt")#</cfif></cfif><br/></cfif>
			<cfif events_link_override eq 1><a href="#events_link#"><cfelse><a href="calendar_detail.cfm?eventid=#eventid#&siteid=#url.siteid#&month=#url.month#&year=#url.year#&day=#url.day#&range=#url.range#&audience=#url.audience#&view=#url.view#&skin=#url.skin#" title="#shortdesc#"></cfif>#shortdesc#</a></li>
