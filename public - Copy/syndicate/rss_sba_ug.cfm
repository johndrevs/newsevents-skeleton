...
WHERE ((to_char(enddate, 'yyyy-mm-dd HH24:MI') >= '#dateformat(currentdate,"yyyy-mm-dd HH:mm")#'))	
...
order by events_tbl.startdate<!---<cfabort> --->
</cfquery>
...
<?xml-stylesheet href="style.xsl" type="text/xsl" media="screen"?>
  <rss version="2.0">
    <channel>
       <title>Loyola University Chicago Upcoming Calendar</title>
...
where locationid=#getevent2.locationid[ctr]#</cfquery>
...
<cfscript>
   ...
   <item>
         <title>#title#</title> 
         <description><cfif (isDefined("getevent2.allday") AND getevent2.allday EQ 1) or timeformat(getevent2.startdate[ctr],"h:mm:tt") EQ '1:00:am'>
	...
	<cfelse>
	</cfif> | <cfset getlocation.location_name=replace(getlocation.location_name, "&", "&amp;", "ALL")>#getlocation.location_name#  #getevent2.specificlocation[ctr]# | #MSRubbish# </description>
         ...
         <endDate>#CreateODBCDateTime(getevent2.enddate[ctr])#</endDate>
   </item>
   </cfoutput>
</cfloop>
<cfoutput>
