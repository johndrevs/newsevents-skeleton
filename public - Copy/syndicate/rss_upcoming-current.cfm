...
WHERE isactive=1 AND shortdesc IS NOT NULL and shortdesc <> ' ' and ((to_char(startdate, 'yyyy-mm-dd HH24:MI') >= '#dateformat(currentdate,"yyyy-mm-dd HH:mm")#') OR (to_char(enddate, 'yyyy-mm-dd HH24:MI') >= '#dateformat(currentdate,"yyyy-mm-dd HH:mm")#'))
